import CustomTwo from "logic/customTwo";
import { round } from "utils";

describe("Custom 2 mode calculation methods", () => {
  describe("getResult method", () => {
    test("should return object with 'T' value for H key, when (a: true, b: true, c: false) and properly calculate relevant function", () => {
      const H_VALUE = "T";
      const a = true;
      const b = true;
      const c = false;
      ...
      const expectedKResult = 1;

      const base = new CustomTwo(a, b, c, d, e, f);
    ...
    test("should return object with 'M' value for H key, when (a: true, b: false, c: true) and properly calculate relevant function", () => {
      const H_VALUE = "M";
      const a = true;
      const b = false;
      const c = true;
  ...
  describe("getM method", () => {
    test("should properly calculate the expression f + d + (d * e) / 100 which overrides expression from Base mod", () => {
      const a = true;
      const b = true;
      const c = false;
      const d = 1.2;
      ...
      const expectedResult = f + d + (d * e) / 100;
      const base = new CustomTwo(a, b, c, d, e, f);
  ...
  describe("getP method", () => {
    test("should properly calculate the expression d + (d * (e - f)) / 25.5 from Base mod", () => {
      const a = true;
      const b = true;
      const c = true;
      const d = 1.2;
